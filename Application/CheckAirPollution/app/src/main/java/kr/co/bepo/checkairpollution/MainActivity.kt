package kr.co.bepo.checkairpollution
...
import kr.co.bepo.checkairpollution.data.models.airquality.MeasuredValue
import kr.co.bepo.checkairpollution.data.models.monitoringstation.MonitoringStation
import kr.co.bepo.checkairpollution.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun fetchAirQualityData() {
        ...
        fusedLocationProviderClient.getCurrentLocation(
            ...
            cancellationTokenSource?.token as CancellationToken
    ...
    fun displayAirQualityData(monitoringStation: MonitoringStation, measuredValue: MeasuredValue) {
        ...
        (measuredValue.khaiGrade ?: Grade.UNKNOWN).let { grade ->
            ...
            binding.totalGradLabelTextView.text = grade.label
            binding.totalGradEmojiTextView.text = grade.emoji
        }
