...
import kr.co.bepo.repositorygithub.BuildConfig
import kr.co.bepo.repositorygithub.data.Url
...
object RetrofitUtil {
    ...
    val authApiString: AuthApiService by lazy { getGithubAuthRetrofit().create(AuthApiService::class.java) }
