package kr.co.bepo.copyrightfreeimage
...
import kr.co.bepo.copyrightfreeimage.data.Repository
import kr.co.bepo.copyrightfreeimage.data.models.PhotoResponse
import kr.co.bepo.copyrightfreeimage.databinding.ActivityMainBinding
            ...
            .into(
                object : CustomTarget<Bitmap>(SIZE_ORIGINAL, SIZE_ORIGINAL) {
                    override fun onResourceReady(
                        ...
                        val wallpaperManger = WallpaperManager.getInstance(this@MainActivity)
                        val snackBar =  Snackbar.make(binding.root, "다운로드 완료", Snackbar.LENGTH_SHORT)

                        if (wallpaperManger.isWallpaperSupported &&
                            (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N &&
                                    wallpaperManger.isSetWallpaperAllowed)) {
